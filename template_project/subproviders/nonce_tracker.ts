...
import providerEngineUtils = require('web3-provider-engine-tiny/util/rpc-cache-utils');

import { Callback, ErrorCallback, NextCallback } from 'sane-subproviders/lib/src/types';
